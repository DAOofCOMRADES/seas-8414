...
st.set_page_config(page_title ="GWU Week-7 Forecast App",
...
if page == "About":
    st.header("Week-7 Demo Application")
    ...
    st.write("")
    st.write("** Revised the code for education purpose **")
